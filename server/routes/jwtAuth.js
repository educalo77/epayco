...
router.post("/register", validInfo, async (req, res) => {
    try {
        ...
        const newUser = await pool.query("INSERT INTO users (user_name, user_email, user_password, user_phone, user_document) VALUES ($1, $2, $3, $4, $5) RETURNING *", [name, email, bcryptPassword, phone, document]);
